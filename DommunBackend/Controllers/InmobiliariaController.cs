...
namespace DommunBackend.Controllers
{
    ...
    public class InmobiliariaController : ControllerBase
    {
        ...
        //[HttpGet(nameof(GetInmobiliaria))]
        //public IActionResult GetInmobiliaria(int id)
        //{
        //    var result = inmobiliariaService.GetInmobiliariaById(id);
        ...
        //[HttpGet(nameof(GetAllInmobiliarias))]
        //public IActionResult GetAllInmobiliarias()
        //{
        //    var result = inmobiliariaService.GetAllInmobiliarias();
        ...
        //[HttpPost(nameof(InsertInmobiliaria))]
        //public IActionResult InsertInmobiliaria(Inmobiliaria customer)
        //{
        //    inmobiliariaService.InsertInmobiliaria(customer);
        ...
        //[HttpPut(nameof(UpdateInmobiliaria))]
        //public IActionResult UpdateInmobiliaria(Inmobiliaria customer)
        //{
        //    inmobiliariaService.UpdateInmobiliaria(customer);
        ...
        //[HttpDelete(nameof(DeleteInmobiliaria))]
        //public IActionResult DeleteInmobiliaria(int Id)
        //{
        //    inmobiliariaService.DeleteInmobiliaria(Id);
